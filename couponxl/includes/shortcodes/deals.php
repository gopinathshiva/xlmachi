...
/*
 * deals_number > no of deals to show in home page
...
function couponxl_deals_params(){
	return array(
		...
		array(
			...
			"holder" => "div",
			"class" => "",
			"heading" => __("Number Of Deals per Row","couponxl"),
			"param_name" => "deals_per_row",
			"value" => "",
			"description" => __("Input number of deals you wish to show per row (3 by default), use 3/4","couponxl")
		),			
		array(
			"type" => "multidropdown",
			"holder" => "div",
