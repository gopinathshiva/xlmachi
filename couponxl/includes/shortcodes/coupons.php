...
function couponxl_coupons_params(){
	return array(
		...
		array(
			...
			"holder" => "div",
			"class" => "",
			"heading" => __("Number Of Coupons to show per Row","couponxl"),
			"param_name" => "coupons_per_row",
			"value" => "",
			"description" => __("Input number of coupons you wish to show per row (3 by default), use 3/4","couponxl")
		),		
		array(
			"type" => "multidropdown",
			"holder" => "div",
