<div class="row xl-coupon-listing">
    ...
    <div class="row" >
      <div class="category_slider">
        <ul>
          <li ><a href="http://couponmachi.com/recharge-coupons"  ><i class="fa fa-flash icon-margin"></i><h6 class="pop-cat-title">Recharge</h6></a></li>
          <li ><a href="http://couponmachi.com/travel-coupons"  ><i class="fa fa-bus icon-margin"></i><h6 class="pop-cat-title">Travel</h6></a></li>
          <li ><a href="http://couponmachi.com/food-dining-coupons"  ><i class="fa fa-cutlery icon-margin"></i><h6 class="pop-cat-title">Food</h6></a></li>
          <li ><a href="http://couponmachi.com/groceries-coupons"  ><i class="fa fa-shopping-cart icon-margin"></i><h6 class="pop-cat-title">Groceries</h6></a></li>
          <li ><a href="http://couponmachi.com/mobiles-tablets-coupons"  ><i class="fa fa-mobile icon-margin"></i><h6 class="pop-cat-title">Mobile/Tablet</h6></a></li>
          <!-- <li ><a   ><i class="fa fa-mobile icon-margin"></i><h6 class="pop-cat-title">Mobile/Tablet</h6></a></li> -->
          <li ><a href="http://couponmachi.com/fashion-coupons"  ><i class="fa fa-female icon-margin"></i><h6 class="pop-cat-title">Fashion</h6></a></li>
