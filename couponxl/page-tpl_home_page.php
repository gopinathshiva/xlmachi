    ...
    <div class="container">
        <div class="row">
            ...
            <!-- 
			    ...
			    <div class="col-sm-6">
				<form method="get" action="<?php echo esc_url( couponxl_get_permalink_by_tpl( 'page-tpl_search_page' ) ) ?>" class="clearfix keyword-search keyword-search-visible">                               			            	
                                    <div class="input-group">
                                        ...
                                        <small>For example start typing: Recharge offers, travel offers</small>
                                    </div>  
				</form>                              
                            </div>
